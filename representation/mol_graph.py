...
from .reference_mol_graph_utils import SMILEStoMol, may_be_isomorphic, is_isomorphic 
...
class MolGraph: 
    ...
    def show_visualization(self, title=None, pos=None, atomTypes=['C','H','N','O','P','S'], draw_edge_labels=False, block=True): 
        # alternative visualization function with fgutils.vis.GraphVisualizer is possible TODO 
        plt.figure() 
